...
*/
IMGUI_API bool TabLabels(const std::vector<std::string> tabLabels, int& selectedIndex, ImVec2& tableSize, const std::vector<std::string> tabLabelTooltips, const std::vector<std::pair<int, int>> badgeNumbers, bool wrapMode=true, bool breathing_select = false, int* pOptionalHoveredIndex=NULL, int* pOptionalItemOrdering=NULL, bool allowTabReorder=true, bool allowTabClosing=false, int* pOptionalClosedTabIndex=NULL,int * pOptionalClosedTabIndexInsideItemOrdering=NULL,bool invertRounding=false);

IMGUI_API bool TabImageLabels(const std::vector<std::string> tabLabels, int& selectedIndex, ImVec2& tableSize, const std::vector<std::string> tabLabelTooltips, const std::vector<std::pair<int, int>> badgeNumbers, const std::vector<ImTextureID> tabTextures, ImVec2 texture_size, bool wrapMode=true, bool breathing_select = false, int* pOptionalHoveredIndex=NULL, int* pOptionalItemOrdering=NULL, bool allowTabReorder=true, bool allowTabClosing=false, int* pOptionalClosedTabIndex=NULL,int * pOptionalClosedTabIndexInsideItemOrdering=NULL,bool invertRounding=false);

// ImGui::TabLabelsVertical() are similiar to ImGui::TabLabels(), but they do not support WrapMode.
IMGUI_API bool TabLabelsVertical(const std::vector<std::string> tabLabels, int& selectedIndex, const std::vector<std::string> tabLabelTooltips, const std::vector<std::pair<int, int>> badgeNumbers, bool breathing_select = false, int* pOptionalHoveredIndex=NULL, int* pOptionalItemOrdering=NULL, bool allowTabReorder=false, bool allowTabClosing=false, int* pOptionalClosedTabIndex=NULL,int * pOptionalClosedTabIndexInsideItemOrdering=NULL,bool invertRounding=false,bool textIsRotatedCCW = false);
