...
#if USE_ARM64
#define SIMD_REINTERPRET(_Tpv, suffix) \
...
#define SIMD_UTILS_SUFFIX(_Tpv, _Tpvl, suffix) \
    SIMD_UNZIP(_Tpv##_t, _Tpv##x2_t, suffix) \
    SIMD_UNZIP_L(_Tpvl##_t, _Tpvl##x2_t, suffix) \
    SIMD_REINTERPRET(_Tpv##_t, suffix)

#define SIMD_UTILS_SUFFIX_I64(_Tpv, _Tpvl, suffix) \
    SIMD_REINTERPRET(_Tpv##_t, suffix)

#define SIMD_UTILS_SUFFIX_F64(_Tpv, _Tpvl, suffix) \
    SIMD_UNZIP(_Tpv##_t, _Tpv##x2_t, suffix)

SIMD_UTILS_SUFFIX(uint8x16, uint8x8,  u8)
SIMD_UTILS_SUFFIX(int8x16,  int8x8,   s8)
SIMD_UTILS_SUFFIX(uint16x8, uint16x4, u16)
SIMD_UTILS_SUFFIX(int16x8,  int16x4,  s16)
SIMD_UTILS_SUFFIX(uint32x4, uint32x2, u32)
SIMD_UTILS_SUFFIX(int32x4,  int32x2,  s32)
SIMD_UTILS_SUFFIX(float32x4, float32x2, f32)
SIMD_UTILS_SUFFIX_I64(uint64x2, uint64x1, u64)
SIMD_UTILS_SUFFIX_I64(int64x2,  int64x1,  s64)
#if USE_ARM64
SIMD_UTILS_SUFFIX_F64(float64x2, float64x1,f64)
#endif
...
struct v_uint8x16
{
    ...
    {
        uint8_t v[] = {v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15};
        val = vld1q_u8(v);
    }
    uint8_t get0() const
    {
...
struct v_int8x16
{
    ...
    {
        int8_t v[] = {v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15};
        val = vld1q_s8(v);
    }
    int8_t get0() const
    {
...
struct v_uint16x8
{
    ...
    {
        uint16_t v[] = {v0, v1, v2, v3, v4, v5, v6, v7};
        val = vld1q_u16(v);
    }
    uint16_t get0() const
    {
...
struct v_int16x8
{
    ...
    {
        int16_t v[] = {v0, v1, v2, v3, v4, v5, v6, v7};
        val = vld1q_s16(v);
    }
    int16_t get0() const
    {
...
#define SIMD_INIT(_Tpv, _Tp, suffix) \
...
SIMD_INIT(uint8x16,  uint8_t,  u8)
SIMD_INIT(int8x16,   int8_t,   s8)
SIMD_INIT(uint16x8,  uint16_t, u16)
SIMD_INIT(int16x8,   int16_t,  s16)
SIMD_INIT(uint32x4,  uint32_t, u32)
SIMD_INIT(int32x4,   int32_t,  s32)
SIMD_INIT(uint64x2,  uint64_t, u64)
SIMD_INIT(int64x2,   int64_t,  s64)
SIMD_INIT(float32x4, float,    f32)
#if USE_ARM64
#define SIMD_INIT_64(_Tpv, suffix) \
inline v_float64x2 v_reinterpret_as_f64(const v_##_Tpv& v) { return v_float64x2(vreinterpretq_f64_##suffix(v.val)); }
SIMD_INIT(float64x2, double, f64)
SIMD_INIT_64(uint8x16,  u8)
SIMD_INIT_64(int8x16,   s8)
SIMD_INIT_64(uint16x8,  u16)
SIMD_INIT_64(int16x8,   s16)
SIMD_INIT_64(uint32x4,  u32)
SIMD_INIT_64(int32x4,   s32)
SIMD_INIT_64(uint64x2,  u64)
SIMD_INIT_64(int64x2,   s64)
SIMD_INIT_64(float32x4, f32)
SIMD_INIT_64(float64x2, f64)
#endif

#define SIMD_PACK(_Tpvec, _Tp, hreg, suffix, _Tpwvec, pack, mov, rshr) \
...
SIMD_PACK(v_uint8x16, uint8_t,  uint8x8_t,  u8,  v_uint16x8, pack,   vqmovn_u16,  vqrshrn_n_u16)
SIMD_PACK(v_int8x16,  int8_t,   int8x8_t,   s8,  v_int16x8,  pack,   vqmovn_s16,  vqrshrn_n_s16)
SIMD_PACK(v_uint16x8, uint16_t, uint16x4_t, u16, v_uint32x4, pack,   vqmovn_u32,  vqrshrn_n_u32)
SIMD_PACK(v_int16x8,  int16_t,  int16x4_t,  s16, v_int32x4,  pack,   vqmovn_s32,  vqrshrn_n_s32)
SIMD_PACK(v_uint32x4, uint32_t, uint32x2_t, u32, v_uint64x2, pack,   vmovn_u64,   vrshrn_n_u64)
SIMD_PACK(v_int32x4,  int32_t,  int32x2_t,  s32, v_int64x2,  pack,   vmovn_s64,   vrshrn_n_s64)
SIMD_PACK(v_uint8x16, uint8_t,  uint8x8_t,  u8,  v_int16x8,  pack_u, vqmovun_s16, vqrshrun_n_s16)
SIMD_PACK(v_uint16x8, uint16_t, uint16x4_t, u16, v_int32x4,  pack_u, vqmovun_s32, vqrshrun_n_s32)
...
SIMD_BIN_OP(+, v_uint8x16,  vqaddq_u8)
SIMD_BIN_OP(-, v_uint8x16,  vqsubq_u8)
SIMD_BIN_OP(+, v_int8x16,   vqaddq_s8)
SIMD_BIN_OP(-, v_int8x16,   vqsubq_s8)
SIMD_BIN_OP(+, v_uint16x8,  vqaddq_u16)
SIMD_BIN_OP(-, v_uint16x8,  vqsubq_u16)
SIMD_BIN_OP(+, v_int16x8,   vqaddq_s16)
SIMD_BIN_OP(-, v_int16x8,   vqsubq_s16)
SIMD_BIN_OP(+, v_int32x4,   vaddq_s32)
SIMD_BIN_OP(-, v_int32x4,   vsubq_s32)
SIMD_BIN_OP(*, v_int32x4,   vmulq_s32)
SIMD_BIN_OP(+, v_uint32x4,  vaddq_u32)
SIMD_BIN_OP(-, v_uint32x4,  vsubq_u32)
SIMD_BIN_OP(*, v_uint32x4,  vmulq_u32)
SIMD_BIN_OP(+, v_float32x4, vaddq_f32)
SIMD_BIN_OP(-, v_float32x4, vsubq_f32)
SIMD_BIN_OP(*, v_float32x4, vmulq_f32)
SIMD_BIN_OP(+, v_int64x2,   vaddq_s64)
SIMD_BIN_OP(-, v_int64x2,   vsubq_s64)
SIMD_BIN_OP(+, v_uint64x2,  vaddq_u64)
SIMD_BIN_OP(-, v_uint64x2,  vsubq_u64)
#if USE_ARM64
SIMD_BIN_OP(/, v_float32x4, vdivq_f32)
SIMD_BIN_OP(+, v_float64x2, vaddq_f64)
SIMD_BIN_OP(-, v_float64x2, vsubq_f64)
SIMD_BIN_OP(*, v_float64x2, vmulq_f64)
SIMD_BIN_OP(/, v_float64x2, vdivq_f64)
#else
...
#define SIMD_LOGIC_OP(_Tpvec, suffix) \
    SIMD_BIN_OP(&, _Tpvec, vandq_##suffix) \
    SIMD_BIN_OP(|, _Tpvec, vorrq_##suffix) \
    SIMD_BIN_OP(^, _Tpvec, veorq_##suffix) \
    inline _Tpvec operator ~ (const _Tpvec& a) \
    { \
        return _Tpvec(vreinterpretq_##suffix##_u8(vmvnq_u8(vreinterpretq_u8_##suffix(a.val)))); \
    }

SIMD_LOGIC_OP(v_uint8x16, u8)
SIMD_LOGIC_OP(v_int8x16,  s8)
SIMD_LOGIC_OP(v_uint16x8, u16)
SIMD_LOGIC_OP(v_int16x8,  s16)
SIMD_LOGIC_OP(v_uint32x4, u32)
SIMD_LOGIC_OP(v_int32x4,  s32)
SIMD_LOGIC_OP(v_uint64x2, u64)
SIMD_LOGIC_OP(v_int64x2,  s64)

#define SIMD_FLT_BIT_OP(bin_op, intrin) \
...
SIMD_FLT_BIT_OP(&, vandq_s32)
SIMD_FLT_BIT_OP(|, vorrq_s32)
SIMD_FLT_BIT_OP(^, veorq_s32)
...
#define SIMD_ABS(_Tpuvec, _Tpsvec, usuffix, ssuffix) \
inline _Tpuvec v_abs(const _Tpsvec& a) { return v_reinterpret_as_##usuffix(_Tpsvec(vabsq_##ssuffix(a.val))); }

SIMD_ABS(v_uint8x16, v_int8x16, u8, s8)
SIMD_ABS(v_uint16x8, v_int16x8, u16, s16)
SIMD_ABS(v_uint32x4, v_int32x4, u32, s32)

inline v_float32x4 v_abs(v_float32x4 x)
{ return v_float32x4(vabsq_f32(x.val)); }

#if USE_ARM64
#define SIMD_DBL_BIT_OP(bin_op, intrin) \
...
SIMD_DBL_BIT_OP(&, vandq_s64)
SIMD_DBL_BIT_OP(|, vorrq_s64)
SIMD_DBL_BIT_OP(^, veorq_s64)
...
SIMD_BIN_FUNC(v_uint8x16,  v_min, vminq_u8)
SIMD_BIN_FUNC(v_uint8x16,  v_max, vmaxq_u8)
SIMD_BIN_FUNC(v_int8x16,   v_min, vminq_s8)
SIMD_BIN_FUNC(v_int8x16,   v_max, vmaxq_s8)
SIMD_BIN_FUNC(v_uint16x8,  v_min, vminq_u16)
SIMD_BIN_FUNC(v_uint16x8,  v_max, vmaxq_u16)
SIMD_BIN_FUNC(v_int16x8,   v_min, vminq_s16)
SIMD_BIN_FUNC(v_int16x8,   v_max, vmaxq_s16)
SIMD_BIN_FUNC(v_uint32x4,  v_min, vminq_u32)
SIMD_BIN_FUNC(v_uint32x4,  v_max, vmaxq_u32)
SIMD_BIN_FUNC(v_int32x4,   v_min, vminq_s32)
SIMD_BIN_FUNC(v_int32x4,   v_max, vmaxq_s32)
SIMD_BIN_FUNC(v_float32x4, v_min, vminq_f32)
SIMD_BIN_FUNC(v_float32x4, v_max, vmaxq_f32)
#if USE_ARM64
SIMD_BIN_FUNC(v_float64x2, v_min, vminq_f64)
SIMD_BIN_FUNC(v_float64x2, v_max, vmaxq_f64)
#endif
...
#endif
#define SIMD_CMP_OP(_Tpvec, cast, suffix, not_suffix) \
inline _Tpvec operator == (const _Tpvec& a, const _Tpvec& b) \
...
SIMD_CMP_OP(v_uint8x16,  SIMD_NOP, u8, u8)
SIMD_CMP_OP(v_int8x16,   vreinterpretq_s8_u8, s8, u8)
SIMD_CMP_OP(v_uint16x8,  SIMD_NOP, u16, u16)
SIMD_CMP_OP(v_int16x8,   vreinterpretq_s16_u16, s16, u16)
SIMD_CMP_OP(v_uint32x4,  SIMD_NOP, u32, u32)
SIMD_CMP_OP(v_int32x4,   vreinterpretq_s32_u32, s32, u32)
SIMD_CMP_OP(v_float32x4, vreinterpretq_f32_u32, f32, u32)
#if USE_ARM64
SIMD_CMP_OP(v_uint64x2,  SIMD_NOP, u64, u64)
SIMD_CMP_OP(v_int64x2,   vreinterpretq_s64_u64, s64, u64)
SIMD_CMP_OP(v_float64x2, vreinterpretq_f64_u64, f64, u64)
#endif
...
SIMD_BIN_FUNC(v_uint8x16, v_add_wrap, vaddq_u8)
SIMD_BIN_FUNC(v_int8x16, v_add_wrap, vaddq_s8)
SIMD_BIN_FUNC(v_uint16x8, v_add_wrap, vaddq_u16)
SIMD_BIN_FUNC(v_int16x8, v_add_wrap, vaddq_s16)
SIMD_BIN_FUNC(v_uint8x16, v_sub_wrap, vsubq_u8)
SIMD_BIN_FUNC(v_int8x16, v_sub_wrap, vsubq_s8)
SIMD_BIN_FUNC(v_uint16x8, v_sub_wrap, vsubq_u16)
SIMD_BIN_FUNC(v_int16x8, v_sub_wrap, vsubq_s16)
SIMD_BIN_FUNC(v_uint8x16, v_mul_wrap, vmulq_u8)
SIMD_BIN_FUNC(v_int8x16, v_mul_wrap, vmulq_s8)
SIMD_BIN_FUNC(v_uint16x8, v_mul_wrap, vmulq_u16)
SIMD_BIN_FUNC(v_int16x8, v_mul_wrap, vmulq_s16)

SIMD_BIN_FUNC(v_uint8x16, v_absdiff, vabdq_u8)
SIMD_BIN_FUNC(v_uint16x8, v_absdiff, vabdq_u16)
SIMD_BIN_FUNC(v_uint32x4, v_absdiff, vabdq_u32)
SIMD_BIN_FUNC(v_float32x4, v_absdiff, vabdq_f32)
#if USE_ARM64
SIMD_BIN_FUNC(v_float64x2, v_absdiff, vabdq_f64)
#endif
...
#define SIMD_BIN_FUNC2(_Tpvec, _Tpvec2, cast, func, intrin) \
inline _Tpvec2 func(const _Tpvec& a, const _Tpvec& b) \
{ \
    return _Tpvec2(cast(intrin(a.val, b.val))); \
}

SIMD_BIN_FUNC2(v_int8x16, v_uint8x16, vreinterpretq_u8_s8, v_absdiff, vabdq_s8)
SIMD_BIN_FUNC2(v_int16x8, v_uint16x8, vreinterpretq_u16_s16, v_absdiff, vabdq_s16)
SIMD_BIN_FUNC2(v_int32x4, v_uint32x4, vreinterpretq_u32_s32, v_absdiff, vabdq_s32)
...
{
#if USE_ARM64
    // ARMv8, which adds support for 64-bit floating-point (so USE_ARM64 is defined),
...
#define SIMD_SHIFT_OP(_Tpvec, suffix, _Tps, ssuffix) \
inline _Tpvec operator << (const _Tpvec& a, int32_t n) \
{ return _Tpvec(vshlq_##suffix(a.val, vdupq_n_##ssuffix((_Tps)n))); } \
inline _Tpvec operator >> (const _Tpvec& a, int32_t n) \
{ return _Tpvec(vshlq_##suffix(a.val, vdupq_n_##ssuffix((_Tps)-n))); } \
template<int32_t n> inline _Tpvec v_shl(const _Tpvec& a) \
{ return _Tpvec(vshlq_n_##suffix(a.val, n)); } \
template<int32_t n> inline _Tpvec v_shr(const _Tpvec& a) \
{ return _Tpvec(vshrq_n_##suffix(a.val, n)); } \
template<int32_t n> inline _Tpvec v_rshr(const _Tpvec& a) \
{ return _Tpvec(vrshrq_n_##suffix(a.val, n)); }

SIMD_SHIFT_OP(v_uint8x16, u8,  int8_t,  s8)
SIMD_SHIFT_OP(v_int8x16,  s8,  int8_t,  s8)
SIMD_SHIFT_OP(v_uint16x8, u16, int16_t, s16)
SIMD_SHIFT_OP(v_int16x8,  s16, int16_t, s16)
SIMD_SHIFT_OP(v_uint32x4, u32, int32_t, s32)
SIMD_SHIFT_OP(v_int32x4,  s32, int32_t, s32)
SIMD_SHIFT_OP(v_uint64x2, u64, int64_t, s64)
SIMD_SHIFT_OP(v_int64x2,  s64, int64_t, s64)

#define SIMD_ROTATE_OP(_Tpvec, suffix) \
template<int32_t n> inline _Tpvec v_rotate_right(const _Tpvec& a) \
{ return _Tpvec(vextq_##suffix(a.val, vdupq_n_##suffix(0), n)); } \
template<int32_t n> inline _Tpvec v_rotate_left(const _Tpvec& a) \
{ return _Tpvec(vextq_##suffix(vdupq_n_##suffix(0), a.val, _Tpvec::nlanes - n)); } \
template<> inline _Tpvec v_rotate_left<0>(const _Tpvec& a) \
{ return a; } \
template<int32_t n> inline _Tpvec v_rotate_right(const _Tpvec& a, const _Tpvec& b) \
{ return _Tpvec(vextq_##suffix(a.val, b.val, n)); } \
template<int32_t n> inline _Tpvec v_rotate_left(const _Tpvec& a, const _Tpvec& b) \
{ return _Tpvec(vextq_##suffix(b.val, a.val, _Tpvec::nlanes - n)); } \
template<> inline _Tpvec v_rotate_left<0>(const _Tpvec& a, const _Tpvec& b) \
{ CV_UNUSED(b); return a; }

SIMD_ROTATE_OP(v_uint8x16, u8)
SIMD_ROTATE_OP(v_int8x16, s8)
SIMD_ROTATE_OP(v_uint16x8, u16)
SIMD_ROTATE_OP(v_int16x8, s16)
SIMD_ROTATE_OP(v_uint32x4, u32)
SIMD_ROTATE_OP(v_int32x4, s32)
SIMD_ROTATE_OP(v_float32x4, f32)
SIMD_ROTATE_OP(v_uint64x2, u64)
SIMD_ROTATE_OP(v_int64x2, s64)
#if USE_ARM64
SIMD_ROTATE_OP(v_float64x2, f64)
#endif

#if defined(__clang__) && defined(__aarch64__)
// avoid LD2 instruction. details: https://github.com/opencv/opencv/issues/14863
#define SIMD_LOAD_LOW_OP(_Tpvec, _Tp, suffix) \
inline _Tpvec v_load_low(const _Tp* ptr) \
{ \
typedef uint64_t CV_DECL_ALIGNED(1) unaligned_uint64; \
uint64_t v = *(unaligned_uint64*)ptr; \
return _Tpvec(v_reinterpret_as_##suffix(v_uint64x2(v, (uint64_t)123456))); \
}
#else
#define SIMD_LOAD_LOW_OP(_Tpvec, _Tp, suffix) \
inline _Tpvec v_load_low(const _Tp* ptr) \
...
#define SIMD_LOADSTORE_OP(_Tpvec, _Tp, suffix) \
inline _Tpvec v_load(const _Tp* ptr) \
{ return _Tpvec(vld1q_##suffix(ptr)); } \
inline _Tpvec v_load_aligned(const _Tp* ptr) \
{ return _Tpvec(vld1q_##suffix(ptr)); } \
SIMD_LOAD_LOW_OP(_Tpvec, _Tp, suffix) \
...
SIMD_LOADSTORE_OP(v_uint8x16, uint8_t, u8)
SIMD_LOADSTORE_OP(v_int8x16, int8_t, s8)
SIMD_LOADSTORE_OP(v_uint16x8, uint16_t, u16)
SIMD_LOADSTORE_OP(v_int16x8, int16_t, s16)
SIMD_LOADSTORE_OP(v_uint32x4, uint32_t, u32)
SIMD_LOADSTORE_OP(v_int32x4, int32_t, s32)
SIMD_LOADSTORE_OP(v_uint64x2, uint64_t, u64)
SIMD_LOADSTORE_OP(v_int64x2, int64_t, s64)
SIMD_LOADSTORE_OP(v_float32x4, float, f32)
#if USE_ARM64
SIMD_LOADSTORE_OP(v_float64x2, double, f64)
#endif
...
#if USE_ARM64
#define SIMD_REDUCE_OP_16(_Tpvec, _Tpnvec, scalartype, func, vectorfunc, suffix) \
...
SIMD_REDUCE_OP_16(v_uint8x16, uint8x8, uint8_t, max, max, u8)
SIMD_REDUCE_OP_16(v_uint8x16, uint8x8, uint8_t, min, min, u8)
SIMD_REDUCE_OP_16(v_int8x16,  int8x8,  int8_t,  max, max, s8)
SIMD_REDUCE_OP_16(v_int8x16,  int8x8,  int8_t,  min, min, s8)

#if USE_ARM64
#define SIMD_REDUCE_OP_8(_Tpvec, _Tpnvec, scalartype, func, vectorfunc, suffix) \
inline scalartype v_reduce_##func(const _Tpvec& a) \
{ \
    return v##vectorfunc##vq_##suffix(a.val); \
}
...
SIMD_REDUCE_OP_8(v_uint16x8, uint16x4, uint16_t, max, max, u16)
SIMD_REDUCE_OP_8(v_uint16x8, uint16x4, uint16_t, min, min, u16)
SIMD_REDUCE_OP_8(v_int16x8,  int16x4,  int16_t,  max, max, s16)
SIMD_REDUCE_OP_8(v_int16x8,  int16x4,  int16_t,  min, min, s16)

#if USE_ARM64
#define SIMD_REDUCE_OP_4(_Tpvec, _Tpnvec, scalartype, func, vectorfunc, suffix) \
inline scalartype v_reduce_##func(const _Tpvec& a) \
{ \
    return v##vectorfunc##vq_##suffix(a.val); \
}
...
SIMD_REDUCE_OP_4(v_uint32x4,  uint32x2,  uint32_t, sum, add, u32)
SIMD_REDUCE_OP_4(v_uint32x4,  uint32x2,  uint32_t, max, max, u32)
SIMD_REDUCE_OP_4(v_uint32x4,  uint32x2,  uint32_t, min, min, u32)
SIMD_REDUCE_OP_4(v_int32x4,   int32x2,   int32_t,  sum, add, s32)
SIMD_REDUCE_OP_4(v_int32x4,   int32x2,   int32_t,  max, max, s32)
SIMD_REDUCE_OP_4(v_int32x4,   int32x2,   int32_t,  min, min, s32)
SIMD_REDUCE_OP_4(v_float32x4, float32x2, float,    sum, add, f32)
SIMD_REDUCE_OP_4(v_float32x4, float32x2, float,    max, max, f32)
SIMD_REDUCE_OP_4(v_float32x4, float32x2, float,    min, min, f32)
...
inline int32_t v_signmask(const v_uint8x16& a)
{
#if USE_ARM64
    ...
    return (int32_t)vgetq_lane_u64(v1, 0) + ((int32_t)vgetq_lane_u64(v1, 1) << 8);
#endif // #if USE_ARM64
}

inline int32_t v_signmask(const v_int8x16& a)
{ return v_signmask(v_reinterpret_as_u8(a)); }

inline int32_t v_signmask(const v_uint16x8& a)
{
#if USE_ARM64
    ...
    return (int32_t)vgetq_lane_u64(v1, 0) + ((int32_t)vgetq_lane_u64(v1, 1) << 4);
#endif // #if USE_ARM64
}
inline int32_t v_signmask(const v_int16x8& a)
{ return v_signmask(v_reinterpret_as_u16(a)); }

inline int32_t v_signmask(const v_uint32x4& a)
{
#if USE_ARM64
    ...
    return (int32_t)vgetq_lane_u64(v1, 0) + ((int32_t)vgetq_lane_u64(v1, 1) << 2);
#endif // #if USE_ARM64
}
inline int32_t v_signmask(const v_int32x4& a)
{ return v_signmask(v_reinterpret_as_u32(a)); }
inline int32_t v_signmask(const v_float32x4& a)
{ return v_signmask(v_reinterpret_as_u32(a)); }
inline int32_t v_signmask(const v_uint64x2& a)
{
#if USE_ARM64
    ...
    return (int32_t)vgetq_lane_u64(v0, 0) + ((int32_t)vgetq_lane_u64(v0, 1) << 1);
#endif // #if USE_ARM64
}
inline int32_t v_signmask(const v_int64x2& a)
{ return v_signmask(v_reinterpret_as_u64(a)); }
#if USE_ARM64
inline int32_t v_signmask(const v_float64x2& a)
{ return v_signmask(v_reinterpret_as_u64(a)); }
#endif

inline int32_t v_scan_forward(const v_int8x16& a) { return trailingZeros32(v_signmask(a)); }
inline int32_t v_scan_forward(const v_uint8x16& a) { return trailingZeros32(v_signmask(a)); }
inline int32_t v_scan_forward(const v_int16x8& a) { return trailingZeros32(v_signmask(a)); }
inline int32_t v_scan_forward(const v_uint16x8& a) { return trailingZeros32(v_signmask(a)); }
inline int32_t v_scan_forward(const v_int32x4& a) { return trailingZeros32(v_signmask(a)); }
inline int32_t v_scan_forward(const v_uint32x4& a) { return trailingZeros32(v_signmask(a)); }
inline int32_t v_scan_forward(const v_float32x4& a) { return trailingZeros32(v_signmask(a)); }
inline int32_t v_scan_forward(const v_int64x2& a) { return trailingZeros32(v_signmask(a)); }
inline int32_t v_scan_forward(const v_uint64x2& a) { return trailingZeros32(v_signmask(a)); }
#if USE_ARM64
inline int32_t v_scan_forward(const v_float64x2& a) { return trailingZeros32(v_signmask(a)); }
#endif

#if USE_ARM64
    #define SIMD_CHECK_ALLANY(_Tpvec, suffix, shift) \
...
SIMD_CHECK_ALLANY(uint8x16, u8, 7)
SIMD_CHECK_ALLANY(uint16x8, u16, 15)
SIMD_CHECK_ALLANY(uint32x4, u32, 31)
...
#define SIMD_SELECT(_Tpvec, suffix, usuffix) \
inline _Tpvec v_select(const _Tpvec& mask, const _Tpvec& a, const _Tpvec& b) \
{ \
    return _Tpvec(vbslq_##suffix(vreinterpretq_##usuffix##_##suffix(mask.val), a.val, b.val)); \
}

SIMD_SELECT(v_uint8x16,  u8,  u8)
SIMD_SELECT(v_int8x16,   s8,  u8)
SIMD_SELECT(v_uint16x8,  u16, u16)
SIMD_SELECT(v_int16x8,   s16, u16)
SIMD_SELECT(v_uint32x4,  u32, u32)
SIMD_SELECT(v_int32x4,   s32, u32)
SIMD_SELECT(v_float32x4, f32, u32)
#if USE_ARM64
SIMD_SELECT(v_float64x2, f64, u64)
#endif

#if USE_ARM64
#define SIMD_EXPAND(_Tpvec, _Tpwvec, _Tp, suffix) \
...
SIMD_EXPAND(v_uint8x16, v_uint16x8, uint8_t,  u8)
SIMD_EXPAND(v_int8x16,  v_int16x8,  int8_t,   s8)
SIMD_EXPAND(v_uint16x8, v_uint32x4, uint16_t, u16)
SIMD_EXPAND(v_int16x8,  v_int32x4,  int16_t,  s16)
SIMD_EXPAND(v_uint32x4, v_uint64x2, uint32_t, u32)
SIMD_EXPAND(v_int32x4,  v_int64x2,  int32_t,  s32)

inline v_uint32x4 v_load_expand_q(const uint8_t* ptr)
{
    typedef uint32_t int32_t CV_DECL_ALIGNED(1) unaligned_uint;
    uint8x8_t v0 = vcreate_u8(*(unaligned_uint*)ptr);
    uint16x4_t v1 = vget_low_u16(vmovl_u8(v0));
    return v_uint32x4(vmovl_u16(v1));
}

inline v_int32x4 v_load_expand_q(const int8_t* ptr)
{
    typedef uint32_t int32_t CV_DECL_ALIGNED(1) unaligned_uint;
...
#define SIMD_UNPACKS(_Tpvec, suffix) \
...
SIMD_UNPACKS(uint8x16,  u8)
SIMD_UNPACKS(int8x16,   s8)
SIMD_UNPACKS(uint16x8,  u16)
SIMD_UNPACKS(int16x8,   s16)
SIMD_UNPACKS(uint32x4,  u32)
SIMD_UNPACKS(int32x4,   s32)
SIMD_UNPACKS(float32x4, f32)
#if USE_ARM64
SIMD_UNPACKS(float64x2, f64)
#endif
...
#define SIMD_EXTRACT(_Tpvec, suffix) \
template <int32_t s> \
...
SIMD_EXTRACT(uint8x16,  u8)
SIMD_EXTRACT(int8x16,   s8)
SIMD_EXTRACT(uint16x8,  u16)
SIMD_EXTRACT(int16x8,   s16)
SIMD_EXTRACT(uint32x4,  u32)
SIMD_EXTRACT(int32x4,   s32)
SIMD_EXTRACT(uint64x2,  u64)
SIMD_EXTRACT(int64x2,   s64)
SIMD_EXTRACT(float32x4, f32)
#if USE_ARM64
SIMD_EXTRACT(float64x2, f64)
#endif

#define SIMD_EXTRACT_N(_Tpvec, _Tp, suffix) \
template<int32_t i> inline _Tp v_extract_n(_Tpvec v) { return vgetq_lane_##suffix(v.val, i); }

SIMD_EXTRACT_N(v_uint8x16,  uint8_t,  u8)
SIMD_EXTRACT_N(v_int8x16,   int8_t,   s8)
SIMD_EXTRACT_N(v_uint16x8,  uint16_t, u16)
SIMD_EXTRACT_N(v_int16x8,   int16_t,  s16)
SIMD_EXTRACT_N(v_uint32x4,  uint32_t, u32)
SIMD_EXTRACT_N(v_int32x4,   int32_t,  s32)
SIMD_EXTRACT_N(v_uint64x2,  uint64_t, u64)
SIMD_EXTRACT_N(v_int64x2,   int64_t,  s64)
SIMD_EXTRACT_N(v_float32x4, float,    f32)
#if USE_ARM64
SIMD_EXTRACT_N(v_float64x2, double,   f64)
#endif

#define SIMD_BROADCAST(_Tpvec, _Tp, suffix) \
template<int32_t i> inline _Tpvec v_broadcast_element(_Tpvec v) { _Tp t = v_extract_n<i>(v); return v_setall_##suffix(t); }

SIMD_BROADCAST(v_uint8x16,  uint8_t,  u8)
SIMD_BROADCAST(v_int8x16,   int8_t,   s8)
SIMD_BROADCAST(v_uint16x8,  uint16_t, u16)
SIMD_BROADCAST(v_int16x8,   int16_t,  s16)
SIMD_BROADCAST(v_uint32x4,  uint32_t, u32)
SIMD_BROADCAST(v_int32x4,   int32_t,  s32)
SIMD_BROADCAST(v_uint64x2,  uint64_t, u64)
SIMD_BROADCAST(v_int64x2,   int64_t,  s64)
SIMD_BROADCAST(v_float32x4, float,    f32)
#if USE_ARM64
SIMD_BROADCAST(v_float64x2, double,   f64)
#endif
...
#if USE_ARM64
#define SIMD_TRANSPOSE4x4(_Tpvec, suffix) \
...
SIMD_TRANSPOSE4x4(uint32x4,  u)
SIMD_TRANSPOSE4x4(int32x4,   s)
SIMD_TRANSPOSE4x4(float32x4, f)
#else // #if USE_ARM64
#define SIMD_TRANSPOSE4x4(_Tpvec, suffix) \
inline void v_transpose4x4(const v_##_Tpvec& a0, const v_##_Tpvec& a1, \
                         const v_##_Tpvec& a2, const v_##_Tpvec& a3, \
...
SIMD_TRANSPOSE4x4(uint32x4,  u32)
SIMD_TRANSPOSE4x4(int32x4,   s32)
SIMD_TRANSPOSE4x4(float32x4, f32)
#endif // #if USE_ARM64

#define SIMD_INTERLEAVED(_Tpvec, _Tp, suffix) \
...
#define SIMD_INTERLEAVED_INT64(tp, suffix) \
...
SIMD_INTERLEAVED(uint8x16,  uint8_t,  u8)
SIMD_INTERLEAVED(int8x16,   int8_t,   s8)
SIMD_INTERLEAVED(uint16x8,  uint16_t, u16)
SIMD_INTERLEAVED(int16x8,   int16_t,  s16)
SIMD_INTERLEAVED(uint32x4,  uint32_t, u32)
SIMD_INTERLEAVED(int32x4,   int32_t,  s32)
SIMD_INTERLEAVED(float32x4, float,    f32)
#if USE_ARM64
SIMD_INTERLEAVED(float64x2, double,   f64)
#endif

SIMD_INTERLEAVED_INT64(int64_t,  s64)
SIMD_INTERLEAVED_INT64(uint64_t, u64)
...
{
    int8_t CV_DECL_ALIGNED(32) elems[16] =
    {
        tab[idx[ 0]],
        tab[idx[ 1]],
        tab[idx[ 2]],
...
inline v_uint8x16 v_lut(const uint8_t* tab, const int32_t* idx) { return v_reinterpret_as_u8(v_lut((int8_t*)tab, idx)); }
inline v_uint8x16 v_lut_pairs(const uint8_t* tab, const int32_t* idx) { return v_reinterpret_as_u8(v_lut_pairs((int8_t*)tab, idx)); }
inline v_uint8x16 v_lut_quads(const uint8_t* tab, const int32_t* idx) { return v_reinterpret_as_u8(v_lut_quads((int8_t*)tab, idx)); }

inline v_int16x8 v_lut(const int16_t* tab, const int32_t* idx)
{
    int16_t CV_DECL_ALIGNED(32) elems[8] =
    {
        tab[idx[0]],
        tab[idx[1]],
        tab[idx[2]],
...
inline v_uint16x8 v_lut(const uint16_t* tab, const int32_t* idx) { return v_reinterpret_as_u16(v_lut((int16_t*)tab, idx)); }
inline v_uint16x8 v_lut_pairs(const uint16_t* tab, const int32_t* idx) { return v_reinterpret_as_u16(v_lut_pairs((int16_t*)tab, idx)); }
inline v_uint16x8 v_lut_quads(const uint16_t* tab, const int32_t* idx) { return v_reinterpret_as_u16(v_lut_quads((int16_t*)tab, idx)); }

inline v_int32x4 v_lut(const int32_t* tab, const int32_t* idx)
{
    int32_t CV_DECL_ALIGNED(32) elems[4] =
    {
        tab[idx[0]],
        tab[idx[1]],
        tab[idx[2]],
...
inline v_uint32x4 v_lut(const uint32_t* tab, const int32_t* idx) { return v_reinterpret_as_u32(v_lut((int32_t*)tab, idx)); }
inline v_uint32x4 v_lut_pairs(const uint32_t* tab, const int32_t* idx) { return v_reinterpret_as_u32(v_lut_pairs((int32_t*)tab, idx)); }
inline v_uint32x4 v_lut_quads(const uint32_t* tab, const int32_t* idx) { return v_reinterpret_as_u32(v_lut_quads((int32_t*)tab, idx)); }
...
inline v_float32x4 v_lut_pairs(const float* tab, const int32_t* idx)
{
    typedef uint64_t CV_DECL_ALIGNED(1) unaligned_uint64;

    uint64_t CV_DECL_ALIGNED(32) elems[2] =
    {
...
inline v_float32x4 v_lut_quads(const float* tab, const int32_t* idx)
{
...
{
    uint32_t CV_DECL_ALIGNED(32) elems[4] =
    {
        tab[vgetq_lane_s32(idxvec.val, 0)],
        tab[vgetq_lane_s32(idxvec.val, 1)],
        tab[vgetq_lane_s32(idxvec.val, 2)],
...
{
    /*int32_t CV_DECL_ALIGNED(32) idx[4];
    v_store(idx, idxvec);
...
inline v_float64x2 v_lut_pairs(const double* tab, const int32_t* idx)
{
...
inline v_float32x4 v_load_expand(const float16_t* ptr)
{
    float16x4_t v =
        ...
        (float16x4_t)vld1_s16((const int16_t*)ptr);
    #else
...
inline void v_pack_store(float16_t* ptr, const v_float32x4& v)
{
    float16x4_t hv = vcvt_f16_f32(v.val);
        ...
        vst1_s16((int16_t*)ptr, (int16x4_t)hv);
    #else
...
inline v_float32x4 v_load_expand(const float16_t* ptr)
{
    const int32_t N = 4;
    float buf[N];
    for( int32_t i = 0; i < N; i++ ) buf[i] = (float)ptr[i];
    return v_load(buf);
}
...
inline void v_pack_store(float16_t* ptr, const v_float32x4& v)
{
    ...
    float buf[N];
    v_store(buf, v);
    for( int32_t i = 0; i < N; i++ ) ptr[i] = float16_t(buf[i]);
}
#endif
...
#undef SIMD_UTILS_SUFFIX
#undef SIMD_UTILS_SUFFIX_I64
#undef SIMD_UTILS_SUFFIX_F64
#undef SIMD_INIT
#undef SIMD_INIT_64
#undef SIMD_PACK
#undef SIMD_BIN_OP
#undef SIMD_MUL_SAT
#undef SIMD_LOGIC_OP
#undef SIMD_FLT_BIT_OP
#undef SIMD_ABS
#undef SIMD_DBL_BIT_OP
#undef SIMD_BIN_FUNC
#undef SIMD_CMP_OP
#undef SIMD_BIN_FUNC2
#undef SIMD_SHIFT_OP
#undef SIMD_ROTATE_OP
#undef SIMD_LOAD_LOW_OP
#undef SIMD_LOADSTORE_OP
#undef SIMD_REDUCE_OP_16
#undef SIMD_REDUCE_OP_8
#undef SIMD_REDUCE_OP_4
#undef SIMD_CHECK_ALLANY
#undef SIMD_SELECT
#undef SIMD_EXPAND
#undef SIMD_UNPACKS
#undef SIMD_EXTRACT
#undef SIMD_EXTRACT_N
#undef SIMD_BROADCAST
#undef SIMD_TRANSPOSE4x4
#undef SIMD_INTERLEAVED
#undef SIMD_INTERLEAVED_INT64
