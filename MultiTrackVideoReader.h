...
struct MultiTrackVideoReader
{
    ...
    virtual std::list<VideoTrackHolder>::iterator TrackListBegin() = 0;
    virtual std::list<VideoTrackHolder>::iterator TrackListEnd() = 0;
    virtual VideoTrackHolder GetTrack(uint32_t idx) = 0;
