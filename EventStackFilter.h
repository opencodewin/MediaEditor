...
namespace MEC
{
    ...
    {
        static MediaCore::VideoFilter::Holder CreateInstance();
        static MediaCore::VideoFilter::Holder LoadFromJson(const imgui_json::value& json);
        ...
        virtual Event* AddNewEvent(int64_t id, int64_t start, int64_t end, int32_t z,
                const BluePrint::BluePrintCallbackFunctions& bpCallbacks) = 0;
