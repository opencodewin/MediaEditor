...
function(precompile_shader_spv SHADER_SPV_HEX_HEADERS SHADER_SRC)
make_directory(${CMAKE_CURRENT_BINARY_DIR}/header)
get_filename_component(SHADER_SRC_NAME_WE ${SHADER_SRC} NAME_WE)
# fp32
set(SHADER_fp32_SRC_NAME_WE "${SHADER_SRC_NAME_WE}_fp32")
set(SHADER_fp32_SPV_HEX_FILE ${CMAKE_CURRENT_BINARY_DIR}/header/${SHADER_fp32_SRC_NAME_WE}.spv.hex.h)
add_custom_command(
    OUTPUT ${SHADER_fp32_SPV_HEX_FILE}
    COMMAND ${GLSLANGVALIDATOR_EXECUTABLE}
    ARGS -Dsfp=float -Dsfpvec2=vec2 -Dsfpvec3=vec3 -Dsfpvec4=vec4 -Dsfpvec8=mat2x4 -Dsfpmat3=mat3 -Dsfpmat4=mat4 -Dsfpmat2=mat2 
         -Dafp=float -Dafpvec2=vec2 -Dafpvec3=vec3 -Dafpvec4=vec4 -Dafpvec8=mat2x4 -Dafpmat3=mat3 -Dafpmat4=mat4 -Dafpmat2=mat2 
...
set_source_files_properties(${SHADER_fp32_SPV_HEX_FILE} PROPERTIES GENERATED TRUE)

# fp16 storage
set(SHADER_fp16s_SRC_NAME_WE "${SHADER_SRC_NAME_WE}_fp16s")
set(SHADER_fp16s_SPV_HEX_FILE ${CMAKE_CURRENT_BINARY_DIR}/header/${SHADER_fp16s_SRC_NAME_WE}.spv.hex.h)
add_custom_command(
    OUTPUT ${SHADER_fp16s_SPV_HEX_FILE}
    COMMAND ${GLSLANGVALIDATOR_EXECUTABLE}
    ARGS -Dsfp=float16_t -Dsfpvec2=f16vec2 -Dsfpvec3=f16vec3 -Dsfpvec4=f16vec4 -Dsfpmat3=f16mat3 -Dsfpmat2=f16mat2 
         -Dafp=float     -Dafpvec2=vec2    -Dafpvec3=vec3 -Dafpvec4=vec4  -Dafpvec8=mat2x4 -Dafpmat2=f16mat2 -Dafpmat3=mat3 -Dafpmat4=mat4
...
set(SHADER_fp16sa_SPV_HEX_FILE ${CMAKE_CURRENT_BINARY_DIR}/header/${SHADER_fp16sa_SRC_NAME_WE}.spv.hex.h)
add_custom_command(
    OUTPUT ${SHADER_fp16sa_SPV_HEX_FILE}
    COMMAND ${GLSLANGVALIDATOR_EXECUTABLE}
    ARGS -Dsfp=float16_t -Dsfpvec2=f16vec2 -Dsfpvec3=f16vec3 -Dsfpvec4=f16vec4 -Dsfpvec8=f16mat2x4 -Dsfpmat3=f16mat3 -Dsfpmat4=f16mat4 -Dsfpmat2=f16mat2
         -Dafp=float16_t -Dafpvec2=f16vec2 -Dafpvec3=f16vec3 -Dafpvec4=f16vec4 -Dafpvec8=f16mat2x4 -Dafpmat3=f16mat3 -Dafpmat4=f16mat4 -Dafpmat2=f16mat2
         "-D buffer_ld1(buf,i)=buf[i]"
         "-D buffer_st1(buf,i,v)={buf[i]=v;}"
         "-D buffer_cp1(buf,i,sbuf,si)={buf[i]=sbuf[si];}"
...
set(SHADER_image_SPV_HEX_FILE ${CMAKE_CURRENT_BINARY_DIR}/header/${SHADER_image_SRC_NAME_WE}.spv.hex.h)
add_custom_command(
...
set(SHADER_image_fp16s_SPV_HEX_FILE ${CMAKE_CURRENT_BINARY_DIR}/header/${SHADER_image_fp16s_SRC_NAME_WE}.spv.hex.h)
add_custom_command(
...
set(SHADER_image_fp16sa_SPV_HEX_FILE ${CMAKE_CURRENT_BINARY_DIR}/header/${SHADER_image_fp16sa_SRC_NAME_WE}.spv.hex.h)
add_custom_command(
...
set(SHADER_fp16p_SPV_HEX_FILE ${CMAKE_CURRENT_BINARY_DIR}/header/${SHADER_fp16p_SRC_NAME_WE}.spv.hex.h)
add_custom_command(
    OUTPUT ${SHADER_fp16p_SPV_HEX_FILE}
    COMMAND ${GLSLANGVALIDATOR_EXECUTABLE}
    ARGS -Dsfp=float -Dsfpvec2=uint -Dsfpvec3=vec3 -Dsfpvec4=uvec2 -Dsfpvec8=uvec4 -Dsfpmat3=mat3 -Dsfpmat2=mat2
         -Dafp=float -Dafpvec2=vec2 -Dafpvec3=vec3 -Dafpvec4=vec4  -Dafpvec8=mat2x4 -Dafpmat3=mat3 -Dafpmat4=mat4 -Dafpmat2=mat2
         "-D buffer_ld1(buf,i)=buf[i]"
         "-D buffer_st1(buf,i,v)={buf[i]=v;}"
         "-D buffer_cp1(buf,i,sbuf,si)={buf[i]=sbuf[si];}"
...
set(SHADER_fp16pa_SPV_HEX_FILE ${CMAKE_CURRENT_BINARY_DIR}/header/${SHADER_fp16pa_SRC_NAME_WE}.spv.hex.h)
add_custom_command(
...
set(SHADER_image_fp16p_SPV_HEX_FILE ${CMAKE_CURRENT_BINARY_DIR}/header/${SHADER_image_fp16p_SRC_NAME_WE}.spv.hex.h)
add_custom_command(
...
set(SHADER_image_fp16pa_SPV_HEX_FILE ${CMAKE_CURRENT_BINARY_DIR}/header/${SHADER_image_fp16pa_SRC_NAME_WE}.spv.hex.h)
add_custom_command(
