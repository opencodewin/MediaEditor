...
public:
    ...
    double GRAY2RGBA(const ImMat& im, ImMat & im_RGB, int video_shift, ImInterpolateMode type = IM_INTERPOLATE_BICUBIC) const;
...
private:
    ...
    void upload_param(const VkMat& Im, VkMat& dst, int video_shift, ImInterpolateMode type) const;
