...
#include "Contrast_shader.h"
#include "ImVulkanShader.h"

namespace ImGui 
{
Contrast_vulkan::Contrast_vulkan(int gpu)
{
...
Contrast_vulkan::~Contrast_vulkan()
{
    if (vkdev)
    {
...
void Contrast_vulkan::upload_param(const VkMat& src, VkMat& dst, float contrast) const
{
