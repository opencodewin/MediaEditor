...
\n\
	// Polar angles \n\
	theta = M_PI * (u / width - center.x); // -pi to pi \n\
	phi = M_PI * (v / height - center.y);	// -pi/2 to pi/2 \n\
\n\
	// Vector in 3D space \n\
...
static const char Fish2Sphere_data[] = 
SHADER_HEADER
SHADER_PARAM
