...
" \n\
vec2 fish_orthographic_to_equidistance(int u, int v) \n\
{ \n\
	float width = p.w; \n\
	float height = p.h; \n\
	float radius = 0.5; \n\
...
{ \n\
    ...
    if (gx >= p.out_w || gy >= p.out_h) \n\
        return; \n\
    vec2 pfish = fish_orthographic_to_equidistance(gx, gy); \n\
...
static const char Orthographic2Equidistance_data[] = 
SHADER_HEADER
SHADER_PARAM
