...
//-----------------------------------------------------------------------------
// [SECTION] STACK LAYOUT Add By Dicky
//-----------------------------------------------------------------------------
// sizeof() == 48
...
//#endif
    ...
    IMGUI_API void          RenderFrameDrawList(ImDrawList* dl, ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f); // add by Dicky
    ...
    IMGUI_API void          SeparatorEx(ImGuiSeparatorFlags flags, float thickness = 1.0f, ImU32 color = IM_COL32_WHITE); // modufi by Dicky
