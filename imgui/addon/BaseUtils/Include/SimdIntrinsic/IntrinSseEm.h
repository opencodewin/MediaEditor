...
#define SIMD_WRAP_1(fun, tp) \
    inline tp _v128_##fun(const tp& a) \
    { return _mm_##fun(a); }

#define SIMD_WRAP_2(fun, tp) \
    inline tp _v128_##fun(const tp& a, const tp& b) \
    { return _mm_##fun(a, b); }

#define SIMD_WRAP_3(fun, tp) \
...
SIMD_WRAP_1(cvtepu8_epi16,  __m128i)
SIMD_WRAP_1(cvtepi8_epi16,  __m128i)
SIMD_WRAP_1(cvtepu8_epi32,  __m128i)
SIMD_WRAP_1(cvtepi8_epi32,  __m128i)
SIMD_WRAP_1(cvtepu16_epi32, __m128i)
SIMD_WRAP_1(cvtepi16_epi32, __m128i)
SIMD_WRAP_1(cvtepu32_epi64, __m128i)
SIMD_WRAP_1(cvtepi32_epi64, __m128i)
SIMD_WRAP_2(min_epu32,      __m128i)
SIMD_WRAP_2(mullo_epi32,    __m128i)
SIMD_WRAP_3(blendv_epi8,    __m128i)
...
template<int i>
inline int64_t _v128_extract_epi64(const __m128i& a)
{
#if defined(USE_SSE4_1)
    return _mm_extract_epi64(a, i);
#else
    DECL_ALIGNED(16) int64_t tmp[2];
