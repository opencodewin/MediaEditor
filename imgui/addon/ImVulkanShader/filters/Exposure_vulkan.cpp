...
#include "Exposure_shader.h"
#include "ImVulkanShader.h"

namespace ImGui 
{
Exposure_vulkan::Exposure_vulkan(int gpu)
{
...
Exposure_vulkan::~Exposure_vulkan()
{
    if (vkdev)
    {
...
void Exposure_vulkan::upload_param(const VkMat& src, VkMat& dst, float exposure) const
{
