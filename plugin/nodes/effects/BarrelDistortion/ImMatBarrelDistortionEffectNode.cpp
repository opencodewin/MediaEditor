...
{
    BP_NODE_WITH_NAME(BarrelDistortionEffectNode, "BarrelDistortion Effect", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Filter#Video#Effect")
    BarrelDistortionEffectNode(BP* blueprint): Node(blueprint) { m_Name = "BarrelDistortion Effect"; }
    ...
    bool DrawCustomLayout(ImGuiContext * ctx, float zoom, ImVec2 origin, ImGui::ImCurveEdit::keys * key) override
    {
        ...
        ImGui::SameLine(320);  if (ImGui::Button(ICON_RESET "##reset_scale##BarrelDistortion")) { _scale = 1.5f; changed = true; }
        if (key) ImGui::ImCurveEditKey("##add_curve_scale##BarrelDistortion", key, "scale##BarrelDistortion", 0.0f, 100.f, 1.f);
        ImGui::EndDisabled();
        ImGui::SliderFloat("Pow##BarrelDistortion", &_pow, 0.0, 1.5f, "%.2f", flags);
        ImGui::SameLine(320);  if (ImGui::Button(ICON_RESET "##reset_pow##BarrelDistortion")) { _pow = 0.25f; changed = true; }
        ImGui::PopItemWidth();
...
BP_NODE_DYNAMIC_WITH_NAME(BarrelDistortionEffectNode, "BarrelDistortion Effect", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Filter#Video#Effect")