...
{ \n\
    bool nextImage = distance(fract(point * p.dots), vec2(0.5, 0.5)) < ( p.progress / distance(point, center)); \n\
    ...
    return nextImage ? rgba_to : rgba_from; \n\
} \n\
\n\
void main() \n\
{ \n\
...
static const char PolkaDots_data[] = 
SHADER_HEADER
SHADER_PARAM
