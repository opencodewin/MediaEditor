...
{
    BP_NODE_WITH_NAME(AudioFadeNode, "Audio Fade", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Fusion#Audio")
    AudioFadeNode(BP* blueprint): Node(blueprint) { m_Name = "Audio Fade"; }
...
BP_NODE_DYNAMIC_WITH_NAME(AudioFadeNode, "Audio Fade", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Fusion#Audio")
